...
//     static HCNetSDK ClientDemo.hCNetSDK = HCNetSDK.INSTANCE;
    ...
    private void initComponents() {
        ...
        jButtonLocalFile = new javax.swing.JButton();
        ...
        jButtonLocalFile.setText("本地文件");
        jButtonLocalFile.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                jButtonLocalFileActionPerformed(evt);
            }
        });
        jPanelPlayInfo.add(jButtonLocalFile);
        jButtonLocalFile.setBounds(160, 140, 70, 23);
   ...
   /*************************************************
    ...
    函数描述:	播放本地保存的录像文件
     *************************************************/
    private void jButtonLocalFileActionPerformed(java.awt.event.ActionEvent evt) {
        try {
            // 创建文件选择器
            JFileChooser fileChooser = new JFileChooser();
            fileChooser.setCurrentDirectory(new File(".\\pic"));
            fileChooser.setDialogTitle("选择录像文件");
            fileChooser.setFileFilter(new javax.swing.filechooser.FileNameExtensionFilter("视频文件", "mp4", "avi", "mov", "mkv"));
            ...
            if (result == JFileChooser.APPROVE_OPTION) {
                ...
                if (Desktop.isDesktopSupported()) {
                    ...
                    if (desktop.isSupported(Desktop.Action.OPEN)) {
                        ...
                        JOptionPane.showMessageDialog(this, "正在使用系统默认播放器播放文件: " + selectedFile.getName());
                    } else {
                        JOptionPane.showMessageDialog(this, "系统不支持文件播放功能");
                    }
                } else {
                    JOptionPane.showMessageDialog(this, "系统不支持桌面操作");
                }
            }
        } catch (IOException e) {
            JOptionPane.showMessageDialog(this, "播放文件时发生错误: " + e.getMessage());
            e.printStackTrace();
        }
    }
    ...
    private javax.swing.JButton jButtonLocalFile;
